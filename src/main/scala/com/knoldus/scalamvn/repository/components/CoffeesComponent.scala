...
import com.knoldus.scalamvn.db.MySqlDBComponent
import com.knoldus.scalamvn.models.{Coffees, Suppliers}
import slick.jdbc.MySQLProfile.api._

class CoffeesComponent extends CoffeesTable with MySqlDBComponent
